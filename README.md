...
- **🤖 Smart Auto-Detect**: Automatically analyzes your code keywords (like `svc #0`, `ecall`, `riscv64`, `rv32i`, `freebsd`, `macho64`, `irvine32`, `win-arm64`) to instantly recommend the perfect build mode.
